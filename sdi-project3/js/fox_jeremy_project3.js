(function() {
  var array, boolean, disneyStore, doNothing, i, number, ohTheHorror, print, stores, target, totalStores, toysRUs, walmart, _i, _len, _ref;
  ...
  boolean = function(itIsBlackFriday) {
    var v;
    if (itIsBlackFriday) {
  ...
  stores = function(object) {
    ...
    v = "We went to " + s + " and we looked at the " + t + ". Yes, all of these stores were very busy, but we were able to get some really good deals on toys for our children.";
    return v;
  };
